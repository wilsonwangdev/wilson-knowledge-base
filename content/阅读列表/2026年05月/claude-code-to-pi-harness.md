...
Mario Zechner（@badlogicgames）打造的极简 **coding agent harness**：只给模型基本工具（读写编辑文件、运行命令），其余全由你定义。支持 15+ 模型提供商（Anthropic、OpenAI、Google、Azure、Mistral、Ollama、Groq）。

### Pi vs Claude Code 的哲学差异
...
- [[poteto-how-i-use-cursor|How I Use Cursor]]
- [[agent-harness-engineering|Agent Harness Engineering]]
- [[claude-agent-team-guide|Building a Team of Claude Agents]]
